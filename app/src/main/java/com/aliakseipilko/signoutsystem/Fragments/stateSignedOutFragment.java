...
public class stateSignedOutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_state_signed_out, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        SegmentControl houseButton = (SegmentControl) getView().findViewById(R.id.house_button2);
        ...
        Button studyPeriodButton = (Button) getView().findViewById(R.id.study_period_button2);
        ...
        Button cancelButton = (Button) getView().findViewById(R.id.cancel_button2);
